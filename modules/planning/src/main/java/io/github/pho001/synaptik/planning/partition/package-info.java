 ...
 * owner-plus-node-ID recipe. Public stateless generation validates a complete node-to-owner
 ...
 * that rule or split one operation occurrence. The compiler currently assembles the complete
 * owner map and calls this operation directly. The package provides no graph-wide orchestration
