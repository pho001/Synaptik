...
/**
 * Carries the exact trailing normalized Shape and positive typed epsilon for no-affine layer
 * normalization.
 *
 ...
 *     retained unchanged
 */
public record LayerNormAttrs(Shape normalizedShape, ScalarValue epsilon)
        implements OperationAttrs {
    /**
     * Creates validated no-affine layer-normalization parameters.
     *
