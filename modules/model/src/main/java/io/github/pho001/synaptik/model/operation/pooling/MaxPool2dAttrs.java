...
/**
 * Immutable intrinsic geometry for two-dimensional NCHW maximum pooling.
 *
 ...
 * the padded window grid; it does not remove a terminal all-padding window.</p>
 *
 * <p>This value contains no tensor, shape, data type, layout, storage, gradient, compiler,
 * backend, or execution state. Record equality and hashing use all nine components.</p>
 *
