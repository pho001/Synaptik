# Requirements Archive: v1.1 CUDA Native Runtime

**Archived:** 2026-04-30
**Status:** SHIPPED

For current requirements, start the next milestone with `$gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
