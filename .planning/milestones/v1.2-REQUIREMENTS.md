# Requirements Archive: v1.2 GPU Region Coverage

**Archived:** 2026-05-01
**Status:** SHIPPED

Current requirements are intentionally reset after milestone close. Start the next milestone with `$gsd-new-milestone` to create a fresh `.planning/REQUIREMENTS.md`.
