...
- ✅ **v1.5 Production-Grade Metal Backend Expansion** - Phases 29-39 shipped 2026-05-02. Scope: broaden Metal dtype, operation, layout, training, router, and lower-copy coverage while preserving explicit fallback.
...
v1.5 shipped on 2026-05-02. Phase artifacts are archived under `.planning/milestones/v1.5-phases/`.
