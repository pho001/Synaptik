...
**Planned waves:**
- [ ] [35-01 Conv/pool semantic and capability contract](phases/35-conv-pool-native-execution/35-01-PLAN.md).
- [ ] [35-02 Conv2D forward native/lowered execution](phases/35-conv-pool-native-execution/35-02-PLAN.md).
