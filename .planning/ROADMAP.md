...
- [x] 003-02-PLAN.md — Apply static cost summaries to backend selection and benchmark reports.
- [x] 003-03-PLAN.md — Lock CPU safeguards, documentation, and Phase 4 cost-model ownership notes.
