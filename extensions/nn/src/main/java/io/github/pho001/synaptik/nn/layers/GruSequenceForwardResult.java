...
/**
 * Carries compact outputs of one statically packed GRU sequence and its restored final state.
 *
 * <p>The output list has one exact {@link GruCell} result per represented time step. Its element
 ...
 */
public record GruSequenceForwardResult(List<Tensor> packedOutputs, Tensor finalHidden) {
    /**
     ...
     */
    public GruSequenceForwardResult {
