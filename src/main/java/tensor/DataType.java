 ...
 * {@link #INT32} is intended for integral index tensors, and {@link #BOOL} is
 * intended for masks and logical reductions. Implicit conversion between
 * integral/boolean tensors and floating tensors is intentionally not supported
 * by the public tensor API.</p>
 */
