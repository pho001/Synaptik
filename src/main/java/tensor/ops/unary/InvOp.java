...
public final class InvOp {
    ...
    public static Tensor build(Tensor input) {
        ...
        Tensor out = TensorPrimitiveBuilder.unary(input, op, "inv", TensorDTypes.requireFloating(input.getDataType()));
        ...
        TensorInternalAccess.setGradientRule(out, context -> {
            ...
            context.accumulate(input, outGrad.neg().mul(out.mul(out)));
        });
        return out;
    }
}
