...
public final class NativeFloat32Storage extends AbstractNativeTensorStorage {
    public NativeFloat32Storage(int size, NativeCpuAllocation allocation) {
        this(size, allocation, 0L, true);
    }

    public NativeFloat32Storage(int size, NativeCpuAllocation allocation, long byteOffset, boolean ownsSegment) {
