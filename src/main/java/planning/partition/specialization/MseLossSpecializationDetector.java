...
/**
 * Finds first-pass MSE loss specialization candidates in planned partitions.
 */
final class MseLossSpecializationDetector {
    ...
    static List<PartitionSpecializationCandidate> findCandidates(
        ...
        for (int terminalNodeId : partition.orderedNodeIds()) {
            ...
            PartitionSpecializationCandidate candidate = matchTerminalReduction(
                    terminalNodeId,
                    partitionNodeIds,
                    partition,
                    context
    ...
    private static PartitionSpecializationCandidate matchTerminalReduction(
            int terminalNodeId,
        ...
        while (true) {
            ...
            PartitionSpecializationCandidate candidate = matchSquare(
                    inputNodeId,
                    reductions.reversed(),
                    partitionNodeIds,
                    partition,
    ...
    private static PartitionSpecializationCandidate matchSquare(
            int squareNodeId,
        ...
        return new PartitionSpecializationCandidate(
                PartitionSpecializationKind.MSE_LOSS,
                candidateNodeIds,
                List.copyOf(inputs),
