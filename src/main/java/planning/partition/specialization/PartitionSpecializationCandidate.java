 ...
 */
public record PartitionSpecializationCandidate(
        ...
        int anchorNodeId,
        String summary,
        PartitionSpecializationPayload payload
) {
    public PartitionSpecializationCandidate(
            PartitionSpecializationKind kind,
            List<Integer> orderedNodeIds,
            List<GraphValueRef> inputValueRefs,
            GraphValueRef outputValueRef,
        ...
        this(
                ...
                anchorNodeId,
                summary,
                PartitionSpecializationPayload.empty()
        );
    }
    ...
    public PartitionSpecializationCandidate {
        ...
        payload = payload == null ? PartitionSpecializationPayload.empty() : payload;
    }
}
