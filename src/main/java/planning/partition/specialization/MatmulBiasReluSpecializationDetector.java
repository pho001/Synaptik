...
/**
 * Finds exact MATMUL -> ADD(bias) -> RELU specialization candidates in planned partitions.
 */
final class MatmulBiasReluSpecializationDetector {
    ...
    static List<PartitionSpecializationCandidate> findCandidates(
        ...
        PartitionSpecializationCandidate candidate = new PartitionSpecializationCandidate(
                PartitionSpecializationKind.MATMUL_ADD_BIAS_RELU,
    ...
    private static List<PartitionSpecializationCandidate> findLinearReluCandidate(
            Partition partition,
            PartitionExecutionPlanningContext context
    ) {
