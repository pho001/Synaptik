...
final class MatmulBiasSpecializationDetector {
    ...
    private static List<PartitionSpecializationCandidate> findLinearBiasCandidate(
            Partition partition,
            PartitionExecutionPlanningContext context
    ) {
        ...
        return List.of(new PartitionSpecializationCandidate(
    ...
    private static List<PartitionSpecializationCandidate> findMatmulAddBiasCandidate(
            Partition partition,
            PartitionExecutionPlanningContext context
    ) {
