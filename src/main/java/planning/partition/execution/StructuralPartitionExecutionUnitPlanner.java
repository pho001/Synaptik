...
/**
 * Backend-neutral partition unit planner.
 *
 ...
 */
final class StructuralPartitionExecutionUnitPlanner {
    private StructuralPartitionExecutionUnitPlanner() {
    }

    static List<ExecutionUnit> buildUnits(Partition partition, PartitionExecutionPlanningContext context) {
