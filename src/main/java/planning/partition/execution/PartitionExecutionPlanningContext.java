...
/**
 * Context available while optimizing partitions.
 *
 ...
 */
public record PartitionExecutionPlanningContext(
        List<CompiledNode> compiledNodes,
        FuseConfig fuseConfig,
        CpuFusionConfig cpuFusionConfig
) {
    public PartitionExecutionPlanningContext {
     ...
     * @param fuseConfig fusion configuration
     */
    public PartitionExecutionPlanningContext(List<CompiledNode> compiledNodes, FuseConfig fuseConfig) {
