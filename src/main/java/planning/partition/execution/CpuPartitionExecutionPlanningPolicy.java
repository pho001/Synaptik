...
/**
 * CPU partition unit planner that fuses fully fusable partitions or shorter fusable subchains.
 */
final class CpuPartitionExecutionPlanningPolicy {
    /**
     ...
     */
    List<ExecutionUnit> buildUnits(Partition partition, PartitionExecutionPlanningContext context) {
    ...
    private List<ExecutionUnit> buildMixedCpuUnits(Partition partition, PartitionExecutionPlanningContext context) {
