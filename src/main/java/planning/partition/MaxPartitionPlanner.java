...
/**
 * Planner that expands each seed into the largest legal backend partition it can find.
 *
 ...
 * into accelerator partitions during automatic discovery.</p>
 */
public final class MaxPartitionPlanner implements PartitionPlanner {
    ...
    public MaxPartitionPlanner(SeedOrdering seedOrdering) {
    ...
    private boolean allowsMixedTrainingPhases(PartitionPlanningRequest request) {
        return PartitionExpansionPolicy.allowsMixedTrainingPhases(request);
    }
