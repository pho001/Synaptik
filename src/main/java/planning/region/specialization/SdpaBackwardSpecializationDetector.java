...
final class SdpaBackwardSpecializationDetector {
    ...
    private static ScoreChain matchScoreChain(int dScoresNodeId, RegionPlanningContext context) {
    ...
    private static ForwardMetadata forwardMetadata(int weightsNodeId, RegionPlanningContext context) {
    ...
    private static int transposedInputNodeId(int nodeId, RegionPlanningContext context) {
