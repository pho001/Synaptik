...
final class ExecutionUnitFactory {
    ...
    static ExecutionUnit buildFusedUnit(Partition partition, RegionPlanningContext context) {
        ...
        return new ExecutionUnit(
                ...
                new RegionPlanningTrace(unitTraceEvents(
    ...
    static List<ExecutionUnit> buildSingleOpUnits(Partition partition, RegionPlanningContext context) {
