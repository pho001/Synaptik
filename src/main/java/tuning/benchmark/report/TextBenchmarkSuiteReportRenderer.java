...
public final class TextBenchmarkSuiteReportRenderer {
    ...
    public static String render(BenchmarkSuiteReport report) {
        ...
        for (var entry : report.bestCoverageByBackend().entrySet()) {
            ...
            sb.append("- backend=").append(entry.getKey())
                    ...
                    .append(" internalCpuMaterializationCount=").append(coverage.internalCpuMaterializationCount())
                    .append(" gradientPublicationMaterializationCount=")
                    .append(coverage.gradientPublicationMaterializationCount())
        ...
        for (int i = 0; i < expectations.size(); i++) {
            ...
            sb.append("- workload=").append(expectation.workloadName())
                    ...
                    .append(expectation.policy().maxInternalCpuMaterializationCount())
                    .append(" maxGradientPublicationMaterializationCount=")
                    .append(expectation.policy().maxGradientPublicationMaterializationCount())
    ...
    private static String formatCoverage(GpuCoverageSummary.BackendCoverage coverage) {
        ...
        return "gpuCoverageRatio=" + formatDouble(coverage.gpuCoverageRatio())
                ...
                + ",gradientPublicationMaterializationCount=" + coverage.gradientPublicationMaterializationCount()
