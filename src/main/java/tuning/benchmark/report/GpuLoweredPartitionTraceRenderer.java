...
/** Stable compact text renderer for lowered GPU partition trace snapshots. */
public final class GpuLoweredPartitionTraceRenderer {
    private GpuLoweredPartitionTraceRenderer() {
    }

    public static String renderCompact(GpuLoweredPartitionTrace manifest) {
        if (manifest == null) {
            return "";
        }
    ...
    private static void appendAssumptions(
            StringBuilder sb, String prefix, java.util.List<GpuLoweredPartitionTrace.ValueAssumption> assumptions
    ) {
