...
public final class StandardWorkloads {
    ...
    public static WorkloadCatalog defaultCatalog() {
        return new WorkloadCatalog()
                ...
                .register(transformerBlockHotPath("training_transformer_block_hot_path"))
                .register(denseLoss("training_dense_loss_small", 8, 16, LossReduction.MEAN))
                .register(reductionChain("training_reduction_chain_small", 8, 32))
                .register(normalization("training_layer_norm_small", NormalizationWorkloadSpec.NormalizationKind.LAYER_NORM, 4, 64, 8, 1, 1e-5))
                .register(indexedLoss("training_cross_entropy_small", LossWorkloadSpec.LossKind.CROSS_ENTROPY_FROM_INDICES, 8, 16, LossReduction.MEAN))
