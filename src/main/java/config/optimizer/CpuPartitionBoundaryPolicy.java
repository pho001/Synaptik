...
/**
 * Policy for which non-elementwise operations may remain inside CPU execution partitions.
 */
public enum CpuPartitionBoundaryPolicy {
    /**
     * Keep CPU partitions limited to elementwise islands.
     */
    ELEMENTWISE_ONLY,
