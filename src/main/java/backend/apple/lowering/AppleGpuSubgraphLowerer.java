...
public final class AppleGpuSubgraphLowerer {
    public AppleGpuSubgraphLoweringResult tryLower(AcceleratorSubgraphSpec subgraph, PartitionPlanningContext context) {
        ...
        AppleGpuMatMulSpec matMulSpec = tryBuildLegacyMatMulSpec(subgraph, context, compute);
