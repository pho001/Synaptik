...
final class GpuAcceleratorPrepareSupport {
    private GpuAcceleratorPrepareSupport() {
    }

    record CpuFallbackPreparation(
    ...
    static CompiledNodeExecutionMetadata interiorMetadata(ComputeBackend backend, PartitionExecutionRole role) {
        return new CompiledNodeExecutionMetadata(backend, null, null, null, null, null, role);
    }

    static LoweredRegion requireLoweredRegion(LoweredRegion loweredRegion, String backendName, int anchorNodeId) {
    ...
    static LoweringFamily resolveLoweringFamily(LoweredRegion loweredRegion, LoweringFamily fallback) {
    ...
    static <P extends PartitionPlan> P requirePlan(
    ...
    static CpuFallbackPreparation prepareCpuFallback(
            PartitionPlan plan,
