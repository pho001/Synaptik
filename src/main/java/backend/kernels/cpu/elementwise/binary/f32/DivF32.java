package backend.kernels.cpu.elementwise.binary.f32;
...
public final class DivF32 {
    ...
    private static void vector(float[] a, float[] b, float[] out) {
        ...
        for (; i < upper; i += SPECIES.length()) {
            FloatVector.fromArray(SPECIES, a, i).div(FloatVector.fromArray(SPECIES, b, i)).intoArray(out, i);
        }
