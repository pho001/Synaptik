...
public class CpuSigmoidKernel implements CpuKernel {
    ...
    public void forwardBF16(Operation op, List<Tensor> inputs, Tensor node, CpuKernelContext context) {
        ...
        if (continuation != null) {
            UnaryBF16.sigmoid(continuation, node.getBFloat16Data(), context.dispatchHints());
            return;
        }
        UnaryBF16.sigmoid(inputs.get(0).getBFloat16Data(), node.getBFloat16Data(), context.dispatchHints());
    }
}
