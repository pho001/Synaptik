...
public final class NegF32 {
    ...
    public static void run(float[] in, float[] out, CpuExecutionMode mode, CpuExecutionConfig config) {
        switch (mode) {
    ...
    private static void parallel(float[] in, float[] out, CpuExecutionConfig config) {
    ...
    private static void parallelVector(float[] in, float[] out, CpuExecutionConfig config) {
