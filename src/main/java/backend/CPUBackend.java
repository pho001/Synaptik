...
public final class CPUBackend {
    ...
    public static CpuNodeExecutionPlan buildExecutionPlan(
        ...
        ResolvedReductionHints reductionHints =
                (op != null && switch (op.opType()) {
                    case SUM, MEAN, REDUCE_MIN, REDUCE_MAX, REDUCE_ALL, REDUCE_ANY -> true;
                    default -> false;
                })
    ...
    private static boolean requiresPreparedInput(
        ...
        return switch (op.opType()) {
            case CONTIGUOUS, RESHAPE, EXPAND, PERMUTE, EXPAND_DIMS, SQUEEZE, SUM, MEAN, REDUCE_MIN, REDUCE_MAX, REDUCE_ALL, REDUCE_ANY, NOOP -> false;
    ...
    private static boolean bypassPreparation(Operation op) {
        ...
        return switch (op.opType()) {
            case CONTIGUOUS, RESHAPE, EXPAND, PERMUTE, EXPAND_DIMS, SQUEEZE, SUM, MEAN, REDUCE_MIN, REDUCE_MAX,
