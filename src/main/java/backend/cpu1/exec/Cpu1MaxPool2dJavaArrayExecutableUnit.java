...
/**
 * Runtime wrapper for a prepared cpu1 MAX_POOL2D node using Java array storage.
 */
public final class Cpu1MaxPool2dJavaArrayExecutableUnit extends Cpu1MaxPool2dExecutableUnit {
    public Cpu1MaxPool2dJavaArrayExecutableUnit(Cpu1PreparedMaxPool2dUnit preparedUnit) {
        super(preparedUnit);
    }
