...
/**
 * Base runtime wrapper for a prepared cpu1 CONV2D node.
 */
public abstract class Cpu1Conv2dExecutableUnit implements Cpu1ExecutableUnit {
    private final Cpu1PreparedConv2dUnit preparedUnit;

    protected Cpu1Conv2dExecutableUnit(Cpu1PreparedConv2dUnit preparedUnit) {
