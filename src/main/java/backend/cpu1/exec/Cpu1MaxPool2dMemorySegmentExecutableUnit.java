...
/**
 * Runtime wrapper for a prepared cpu1 MAX_POOL2D node using native CPU segment storage.
 */
public final class Cpu1MaxPool2dMemorySegmentExecutableUnit extends Cpu1MaxPool2dExecutableUnit {
    public Cpu1MaxPool2dMemorySegmentExecutableUnit(Cpu1PreparedMaxPool2dUnit preparedUnit) {
        super(preparedUnit);
    }
    ...
    public void run(ExecutionContext context) {
        ...
        Cpu1PreparedMaxPool2dUnit preparedUnit = preparedUnit();
