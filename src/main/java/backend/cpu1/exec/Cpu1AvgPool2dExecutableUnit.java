...
/**
 * Base runtime wrapper for a prepared cpu1 AVG_POOL2D node.
 */
public abstract class Cpu1AvgPool2dExecutableUnit implements Cpu1ExecutableUnit {
    private final Cpu1PreparedAvgPool2dUnit preparedUnit;

    protected Cpu1AvgPool2dExecutableUnit(Cpu1PreparedAvgPool2dUnit preparedUnit) {
