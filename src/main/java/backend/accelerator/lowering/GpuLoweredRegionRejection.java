 ...
 *
 * @param level attribution level such as original_op, primitive, fused_subpattern, or region_boundary
 ...
 */
public record GpuLoweredRegionRejection(
        String level,
        int originalNodeId,
        String primitiveId,
    ...
    public GpuLoweredRegionRejection {
