...
/**
 * Value-level dtype/layout/storage assumptions captured for a lowered GPU partition.
 *
 ...
 */
public record GpuLoweredPartitionValueAssumption(
        int nodeId,
        String role,
        DataType dataType,
        int rank,
    ...
    public GpuLoweredPartitionValueAssumption {
