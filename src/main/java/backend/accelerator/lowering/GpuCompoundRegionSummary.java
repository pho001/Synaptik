...
/**
 * Backend-neutral summary for a compound GPU region beside the lowered accelerator DAG.
 *
 ...
 */
public record GpuCompoundRegionSummary(
    ...
    public GpuCompoundRegionSummary {
     ...
     */
    public static GpuCompoundRegionSummary none(ComputeBackend backend, List<Integer> nodeIds) {
        return unsupported(
                backend,
                GpuCompoundPatternType.NONE,
                GpuLoweringUnsupportedReason.COMPOUND_PATTERN_UNSUPPORTED,
                "region is not a recognized compound GPU pattern",
                nodeIds,
                List.of(),
                List.of(),
                List.of(),
     ...
     */
    public static GpuCompoundRegionSummary supported(
            ComputeBackend backend,
            GpuCompoundPatternType patternType,
            List<Integer> orderedNodeIds,
            List<Integer> externalInputNodeIds,
        ...
        return new GpuCompoundRegionSummary(
                backend,
                patternType,
                true,
     ...
     */
    public static GpuCompoundRegionSummary unsupported(
            ComputeBackend backend,
            GpuCompoundPatternType patternType,
            GpuLoweringUnsupportedReason reason,
            String detail,
