...
public enum AcceleratorBufferReasonCode {
    ...
    GPU_LAYOUT_BROADCAST_MATERIALIZATION_AVAILABLE,
    GPU_LAYOUT_BROADCAST_MATERIALIZATION_UNSUPPORTED,
    GPU_LAYOUT_STRIDED_NATIVE_COMPUTE_AVAILABLE,
    GPU_LAYOUT_STRIDED_NATIVE_COMPUTE_UNSUPPORTED,
