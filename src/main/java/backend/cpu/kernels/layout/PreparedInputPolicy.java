...
final class PreparedInputPolicy {
    ...
    static boolean bypassPreparation(Operation op) {
        ...
        return switch (op.opType()) {
            case CONTIGUOUS, RESHAPE, EXPAND, SELECT, SLICE, SLICE_GRAD, CONCAT, PERMUTE, EXPAND_DIMS, SQUEEZE, CAST,
                    GATHER_AXIS, GATHER_AXIS_GRAD,
    ...
    static boolean requiresPreparedInput(
        ...
        if (input.hasStorageOffset()) {
            ...
            return switch (op.opType()) {
                case RESHAPE, EXPAND, SELECT, SLICE, SLICE_GRAD, CONCAT, PERMUTE, EXPAND_DIMS, SQUEEZE, CAST,
                        GATHER, GATHER_GRAD, GATHER_AXIS, GATHER_AXIS_GRAD,
                        TAKE_ALONG_AXIS, TAKE_ALONG_AXIS_GRAD, SCATTER_ADD, SCATTER_ELEMENTS, SCATTER_ND,
