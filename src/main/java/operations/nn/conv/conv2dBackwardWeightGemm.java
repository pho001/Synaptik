...
/**
 * Describes GEMM-lowered NCHW 2-D convolution backward computation for the weight gradient.
 *
 ...
 */
public final class conv2dBackwardWeightGemm implements Operation {
     ...
     * @param weightShape rank-4 shape of the requested weight gradient
     * @throws IllegalArgumentException if options are null or the shape is not
     *        rank 4
     */
    public conv2dBackwardWeightGemm(Conv2dOptions options, int[] weightShape) {
        if (options == null) {
    ...
    /**
     * Returns a defensive copy of the requested weight gradient shape.
     *
    ...
    public OpType opType() {
        return OpType.CONV2D_BACKWARD_WEIGHT_GEMM;
    }

    @Override
    public String getExpression() {
        return "conv2d_backward_weight_gemm";
    }
}
