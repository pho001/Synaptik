...
public final class MemoryPlan {
    ...
    private void appendStructuralView(StringBuilder sb) {
        ...
        sb.append("optimizedRegions=").append(regionPlan.structuralView().optimizedRegionIds().size()).append('\n');
        ...
        if (!regionPlan.structuralView().optimizedRegionIds().isEmpty()) {
            sb.append("regionIds=").append(regionPlan.structuralView().optimizedRegionIds()).append('\n');
        }
