...
final class TensorLifetimePlanner {
    private TensorLifetimePlanner() {
    }

    static TensorLifetimePlan plan(List<Tensor> sortedGraph) {
        ...
        return new TensorLifetimePlan(Map.copyOf(lifetimes), forwardBoundaryIndex);
    }
