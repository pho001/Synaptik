...
class DefaultRegionPlannerServiceTest {
    @Test
    void defaultRegionOptimizerBuildsCpuExecutionUnits() {
        ...
        PlannedRegion result = new DefaultRegionPlanner().planRegion(
                partition,
                new RegionPlanningContext(CompiledNodeSnapshotter.snapshot(graph, BackendIntentPlan.empty()), FuseConfig.inferenceDefaults())
        );
