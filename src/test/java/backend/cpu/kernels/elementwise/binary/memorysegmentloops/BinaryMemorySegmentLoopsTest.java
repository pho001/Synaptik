...
class BinaryMemorySegmentLoopsTest {
    @Test
    void denseMemorySegmentLoopRunsBinaryKernelsByDtype() {
        ...
        BinaryMemorySegmentLoops.runSegmentDense(new CpuSubKernel(), bindings(
                DataType.FLOAT32,
        ...
        BinaryMemorySegmentLoops.runSegmentDense(new CpuPowTensorKernel(), bindings(
                DataType.FLOAT64,
        ...
        BinaryMemorySegmentLoops.runSegmentDense(new CpuMulKernel(), bindings(
                DataType.BFLOAT16,
    ...
    void denseMemorySegmentLoopUsesSpecializedAddByDtype() {
        ...
        BinaryMemorySegmentLoops.runAddSegmentDense(bindings(DataType.FLOAT32, MemorySegment.ofArray(leftF32), MemorySegment.ofArray(rightF32), MemorySegment.ofArray(outF32), 3));
        ...
        BinaryMemorySegmentLoops.runAddSegmentDense(bindings(DataType.FLOAT64, MemorySegment.ofArray(leftF64), MemorySegment.ofArray(rightF64), MemorySegment.ofArray(outF64), 3));
        ...
        BinaryMemorySegmentLoops.runAddSegmentDense(bindings(DataType.BFLOAT16, MemorySegment.ofArray(leftBF16), MemorySegment.ofArray(rightBF16), MemorySegment.ofArray(outBF16), 3));
