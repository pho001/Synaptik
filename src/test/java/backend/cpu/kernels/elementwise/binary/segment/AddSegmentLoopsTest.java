...
class AddSegmentLoopsTest {
    ...
    void denseMemorySegmentLoopAddsF32F64AndBf16() {
        ...
        AddSegmentLoops.runSegmentDense(bindings(DataType.FLOAT32, MemorySegment.ofArray(leftF32), MemorySegment.ofArray(rightF32), MemorySegment.ofArray(outF32), 3));
        ...
        AddSegmentLoops.runSegmentDense(bindings(DataType.FLOAT64, MemorySegment.ofArray(leftF64), MemorySegment.ofArray(rightF64), MemorySegment.ofArray(outF64), 3));
        ...
        AddSegmentLoops.runSegmentDense(bindings(DataType.BFLOAT16, MemorySegment.ofArray(leftBF16), MemorySegment.ofArray(rightBF16), MemorySegment.ofArray(outBF16), 3));

        assertArrayEquals(new double[]{5.0, 3.0, 2.0}, toDouble(outBF16), 0.0);
    }

    @Test
    void cpuNativeAddUsesAddSegmentLoopAndPublishesNativeOutput() {
