...
final class AppleGpuBackwardBenchmarkTest {
    ...
    void benchmarkMatmulSumBackwardF32() {
        ...
        run(
                "APPLE_GPU_BACKWARD_MATMUL_SUM_F32",
                matmulSumWorkload("apple_gpu_backward_matmul_sum_f32", 512, 1024, 1024),
                baselineProfile("apple-cpu-backward-matmul-sum-f32"),
                gpuProfile("apple-metal-backward-matmul-sum-f32-gpu")
        );
    }
    ...
    void benchmarkLinearBiasTanhSumBackwardF32() {
        assumeAppleShimConfigured();
        run(
                "APPLE_GPU_BACKWARD_LINEAR_BIAS_TANH_SUM_F32",
                linearBiasTanhSumWorkload("apple_gpu_backward_linear_bias_tanh_sum_f32", 512, 1024, 1024),
                baselineProfile("apple-cpu-backward-linear-bias-tanh-sum-f32"),
                gpuProfile("apple-metal-backward-linear-bias-tanh-sum-f32-gpu")
        );
    }
