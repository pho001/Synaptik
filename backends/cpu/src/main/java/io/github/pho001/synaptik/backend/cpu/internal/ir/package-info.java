 ...
 *
 * <p>The representation records typed boundary and virtual values, one nineteen-opcode
 * family-oriented pointwise vocabulary, exact typed scalar-immediate bits, ordered computation,
