 ...
 */
public final class CpuNativeBuffer extends CpuBufferRepresentation {
     ...
     */
    public static CpuNativeBuffer allocate(DataType dataType, long byteSize, long byteAlignment) {
     ...
     * @return the positive power-of-two alignment in bytes */
    public long byteAlignment() { return byteAlignment; }

    /** @return whether close has begun; safe to query concurrently */
    @Override protected boolean isClosed() { return closed.get(); }
