 ...
 * Schema 59 identifies scalar BFLOAT16 pointwise bodies without a cross-type CAST. Schema 60 is
 * selected only when pointwise IR contains cross-type CAST; unchanged schema-52 and schema-59
 * projections preserve their prior structural keys and generated bytes.
