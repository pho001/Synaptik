 ...
 * schema-36 artifact, including only guarded cold-proved forms admitted by that artifact.
 ...
 * current schema-36 signature before realizing one multi-store artifact; schema 18 introduced
 ...
 * no workspace or materialization, and finalization realizes one current schema-36 artifact that
 ...
 * realize one current schema-36 artifact. Floating numerical rows declare exact run-owned
