 ...
 * exact ordered {@code double[]} or {@code MemorySegment} carrier pattern. Segment vector access
 * uses native byte order. Dense, scalar-broadcast, last-axis, and block/outer regimes admit
 * unmasked complete vectors followed by the existing scalar body for every remainder; the general
 * odometer remains scalar. Emitters do not inspect graph nodes, choose numerical policy, select a
