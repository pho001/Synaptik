...
| 0009 | [Portable CPU coverage and implementation-closure checkpoint](tasks/0009-portable-generated-coverage-closure-checkpoint.md) | Ready | 0001–0008P; complete 0008Q1 and its documentation pass; completed 0008Q1A and its documentation pass; current checked semantic inventory | Parent/current checkpoint. Every advertised CPU form must be direct Java, retained bounded generation, or exact rejection, with semantics, invocation, and hot-loop hygiene. The 6,009 catalog remains historical inspection evidence; universal structural promotion and new performance gates are not required. |
...
| 0009F | [Hybrid route decisions for specialized compute families](tasks/0009f-hybrid-route-decisions-for-specialized-compute-families.md) | Ready | 0009E3 | Incomplete parent. F1 and F2 pooling are complete; F3 is the sole detailed Ready frontier. Parent governs separate MATMUL/convolution, pooling, attention, and batch-normalization decisions; do not apply a universal structural verifier or common route mandate. |
...
| 0009F3 | [Attention and BatchNorm route decisions](tasks/0009f3-attention-and-batch-normalization-route-decisions.md) | Ready | 0009F2 | Sole detailed frontier. Independently retains the current generated attention, inference BatchNorm, and training/statistic-transition BatchNorm routes because complete direct replacement and retirement is not strictly cheaper. |
| 0009G | Final support, correctness, hygiene, and inventory checkpoint | Draft | 0009F3 | Verify advertised direct/generated/rejected forms, semantics, invocation, selected routes, retirement, docs, and hot-loop hygiene. Report existing performance facts; fresh profiling is optional and non-blocking absent a correctness regression. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C/E2/E3 remain historical evidence. Parent CPU 0009D is Complete: D1--D4 retained generated routes. E1 retains partial integral, E1A retains masked, E1B1 retains log-sum-exp, E1B2 retains FLOAT64/FLOAT32/BFLOAT16 VARIANCE/STANDARD_DEVIATION, E1B3 retains FLOAT64/FLOAT32/BFLOAT16 L1_NORM/L2_NORM, E1C retains FLOAT64/FLOAT32/BFLOAT16 SOFTMAX/LOG_SOFTMAX, E2 retains static Layer/RMS, and E3 separately retains MSE, dense categorical, and index categorical generated routes because direct Java would increase implementation and verification work. E1B, E1C, E2, and E3 are Complete; 0009F1 and F2 are Complete. Parent 0009F remains Ready and incomplete; F3 is the sole detailed Ready frontier, while 0009G remains later Draft. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
remain Draft. Prepare
0003A is Complete.
