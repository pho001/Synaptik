...
| 0008Q1A | [Vector scalar-power hot-path self-containment](tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md) | Ready | 0005F, 0005I, 0007A1A, 0008L, 0008Q; independent 0008Q1 structural failure | Remove avoidable Synaptik helper calls from every currently generated FLOAT32/FLOAT64 vector scalar-power special realization across array, segment, and mixed carriers; prove semantic/Class-File parity with optimal clean Java and pass proportionate five-fork generated/direct evidence. This corrective descendant is intentionally ordered before its blocked parent. |
| 0008Q1 | [Finite scalar-immediate and clamp matrix](tasks/0008q1-finite-scalar-immediate-clamp-matrix.md) | Blocked | 0005F, 0005G, 0005J, 0008J, 0008L, 0008Q; complete 0008Q1A and its documentation pass; then-current pointwise lowering/preparation/generation | Complete source-derived finite operation/type/carrier/layout/strategy/shape projection basis after regenerating artifacts affected by 0008Q1A, including scalar-power and ordered-clamp code-shaping categories, exact fixture hashes, independent clean-Java oracles, and fail-closed constants-only proofs. |
| 0009 | [Portable generated-coverage closure checkpoint](tasks/0009-portable-generated-coverage-closure-checkpoint.md) | Blocked | 0001–0008P; complete 0008Q1A, 0008Q1, and their documentation passes; explicitly including 0005A–0005J, corrective 0007A0A–0007A1O and any later residual corrections selected before 0007A2, 0007A–0007F2 including 0007A1/0007A2 and 0007F/0007F1/0007F2, Prepare 0003A, CPU 0008E1, CPU 0008G1, and the ordered 0008A–0008P sequence; complete current selected Model semantic inventory | Bounded source-derived inventory and evidence closure: distinguish capability/admission/selection; ledger exact Class-File hashes and only completed 0008Q1's proved scalar/clamp matrix provenance without enumerating arbitrary immediates; retain 0008I missing, 0008O non-passing, and 0008P `KEEP_WHOLE_CELL`; rerun only justified finite missing/stale/non-representative hot forms. |
...
power. Corrective CPU 0008Q1A is therefore Ready immediately before its parent and covers every
current FLOAT32/FLOAT64 special vector realization and carrier form, not only the first fixture.
CPU 0008Q1 is Blocked on 0008Q1A and its documentation pass. CPU 0009 remains Blocked on the
ordered remediation, completed matrix, and both documentation passes. CPU 0010 through 0017
