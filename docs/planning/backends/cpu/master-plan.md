...
| 0009F | [Hybrid route decisions for specialized compute families](tasks/0009f-hybrid-route-decisions-for-specialized-compute-families.md) | Ready | 0009E3 | Incomplete parent. F1 is complete; F2 pooling is the sole next Draft summary frontier. Parent governs separate MATMUL/convolution, pooling, attention, and batch-normalization decisions; do not apply a universal structural verifier or common route mandate. |
...
| 0009F2 | Pooling hybrid decision | Draft | 0009F1 | Sole next Draft summary frontier; do not detail yet. Decide exact Pool1d composition separately from direct Pool2d and Pool3d window bodies. |
