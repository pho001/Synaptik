...
| 0009E1C | [Softmax-style reduction route decision](tasks/0009e1c-softmax-style-reduction-route-decision.md) | Ready | 0009E1B3 | Sole detailed frontier: decide retained bounded generation versus finite direct typed Java for the complete first-class SOFTMAX/LOG_SOFTMAX stable complete-slice matrix by total implementation and verification cost, with no benchmark gate or performance claim. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3 remain historical evidence. Parent CPU 0009D is Complete: D1--D4 retained generated routes. E1 retains partial integral, E1A retains masked, E1B1 retains log-sum-exp, E1B2 retains FLOAT64/FLOAT32/BFLOAT16 VARIANCE/STANDARD_DEVIATION, and E1B3 retains FLOAT64/FLOAT32/BFLOAT16 L1_NORM/L2_NORM generated routes because direct Java would increase implementation and verification work. E1B is Complete; E1C is the sole detailed Ready frontier, while E2, E3, 0009F, and 0009G remain Draft summaries. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
