...
| 0009E1A | [Masked reduction route decision](tasks/0009e1a-masked-reduction-route-decision.md) | Ready | 0009E1 | Sole detailed frontier: decide the current FLOAT64/FLOAT32/BFLOAT16 masked SUM/MEAN generated route versus finite direct typed Java across directional BOOL broadcast, exact state, dense/general layouts, and heap/segment/mixed carriers; no benchmark gate. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1 remain historical evidence. Parent CPU 0009D is Complete: D1 retained aggregate generation because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split complexity; D2 retained scan generation because a direct replacement would duplicate typed carrier/layout, BFLOAT16, complete-slice range, and guarded segment bodies while adding retirement evidence; D3 retained ordering because a direct route would duplicate the 192-row typed carrier/layout, stable-comparison, logical-index, scratch, cold-binding, and retirement-proof topology; D4 retained the complete 32-row fold family; and E1 retained the dense-array INT32/INT64 modular SUM/PROD partial route because replacing its typed generated partial/combine bodies would add direct selection, binding, replacement, and retirement proof. Detailed E1A masked is the sole Ready frontier; E1B advanced, E1C softmax-style, E2 normalization, and E3 loss remain ordered summaries, followed by 0009F hybrid decisions and the 0009G support/correctness/hygiene/inventory checkpoint. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
