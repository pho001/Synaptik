...
| 0008Q1 | [Finite scalar-immediate and clamp matrix](tasks/0008q1-finite-scalar-immediate-clamp-matrix.md) | Ready | 0005F, 0005G, 0005J, 0008J, 0008L, 0008Q; current schema-63 pointwise lowering/preparation/generation | Complete source-derived finite operation/type/carrier/layout/strategy/shape projection basis, including scalar-power and ordered-clamp code-shaping categories, exact fixture hashes, independent clean-Java oracles, and fail-closed constants-only proofs. |
| 0009 | [Portable generated-coverage closure checkpoint](tasks/0009-portable-generated-coverage-closure-checkpoint.md) | Blocked | 0001–0008P; complete 0008Q1 and its documentation pass; explicitly including 0005A–0005J, corrective 0007A0A–0007A1O and any later residual corrections selected before 0007A2, 0007A–0007F2 including 0007A1/0007A2 and 0007F/0007F1/0007F2, Prepare 0003A, CPU 0008E1, CPU 0008G1, and the ordered 0008A–0008P sequence; complete current selected Model semantic inventory | Bounded source-derived inventory and evidence closure: distinguish capability/admission/selection; ledger exact Class-File hashes and only 0008Q1's proved scalar/clamp matrix provenance without enumerating arbitrary immediates; retain 0008I missing, 0008O non-passing, and 0008P `KEEP_WHOLE_CELL`; rerun only justified finite missing/stale/non-representative hot forms. |
...
and CPU 0008Q is Complete as a strict two-fixture BFLOAT16 scalar-MUL mechanism only. CPU 0008Q1 is Ready as the complete finite scalar-immediate/clamp matrix task, and CPU 0009 remains Blocked on 0008Q1 and its documentation pass. CPU 0010 through 0017 remain Draft. Prepare
0003A is Complete.
