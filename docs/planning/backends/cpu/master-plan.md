...
| 0009D | [Aggregate, scan, ordering, and fold direct-Java migration parent](tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) | Ready | 0009C; completed 0009D1A | Sequence static bounded families as direct typed Java: aggregate, scan, ordering, then fold. Completed 0009A--C/D1A remain historical evidence; no universal structural verifier or benchmark gate. |
| 0009D1 | [Aggregate direct-Java migration and generated retirement](tasks/0009d1-aggregate-structural-oracle-closure.md) | Ready | 0009C; 0009D; completed 0009D1A | Active frontier: cold-bound finite typed aggregate kernels, semantic/invocation/hygiene validation, then selected generated aggregate and incomplete structural-scaffolding retirement. |
...
| 0009D2 | Scan direct-Java migration | Draft | 0009D1 | Summary only: migrate static scan recurrence to typed range-owned Java entries; legacy is read-only behavioral/test evidence; no performance gate. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1A remain historical evidence. Parent CPU 0009D and detailed D1 are Ready: D1 migrates aggregate execution to cold-selected finite typed Java and retires selected generated aggregate artifacts plus incomplete structural scaffolding only after semantic, invocation, conformance, and no-reference validation. D2 scan, D3 ordering, and D4 fold remain summary-only direct-Java migrations. CPU 0009E is split into summary reductions, normalization, and loss children; CPU 0009F makes explicit hybrid decisions for retained generated MATMUL/convolution and pooling/attention/batch-norm orchestration; CPU 0009G is final support/correctness/hygiene/inventory closure. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
