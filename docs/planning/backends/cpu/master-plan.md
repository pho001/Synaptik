...
| 0009E1B | Advanced reduction route-decision parent | Draft | 0009E1A | Parent only: shared advanced geometry has three materially distinct numerical owners; keep E1B1--E1B3 ordered and bounded. |
...
| 0009E1B2 | [Statistical reduction route decision](tasks/0009e1b2-statistical-reduction-route-decision.md) | Ready | 0009E1B1 | Sole next detailed child: decide the current VARIANCE/STANDARD_DEVIATION corrected two-pass exact-mean workspace route under the hybrid policy; no benchmark gate or performance claim. |
| 0009E1B3 | Norm reduction route decision | Draft | 0009E1B2 | Summary only: L1/L2 retain their distinct exact-absolute-sum and scaled-squares numerical ownership. |
| 0009E1C | Softmax-style reduction route decision | Draft | 0009E1B3 | Summary only: first-class SOFTMAX/LOG_SOFTMAX stable complete slices and their current validation/carrier matrix. |
| 0009E2 | Normalization direct-Java migration | Draft | 0009E1C | Summary child: layer/RMS and static normalization loops, with exact current numerical semantics. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1 remain historical evidence. Parent CPU 0009D is Complete: D1 retained aggregate generation because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split complexity; D2 retained scan generation because a direct replacement would duplicate typed carrier/layout, BFLOAT16, complete-slice range, and guarded segment bodies while adding retirement evidence; D3 retained ordering because a direct route would duplicate the 192-row typed carrier/layout, stable-comparison, logical-index, scratch, cold-binding, and retirement-proof topology; D4 retained the complete 32-row fold family; E1 retained the dense-array INT32/INT64 modular SUM/PROD partial route; E1A retained the complete FLOAT64/FLOAT32/BFLOAT16 masked SUM/MEAN route; and E1B1 retained the complete FLOAT64/FLOAT32/BFLOAT16 LOG_SUM_EXP route because direct Java would duplicate typed carrier/layout traversal, cold selection/binding, invocation, inventory, and retirement proof. E1B remains a Draft parent split by distinct numerical ownership; E1B2 statistics is the sole next Ready detailed child, while E1B3 norms, E1C softmax-style, E2 normalization, and E3 loss remain Draft summaries, followed by 0009F hybrid decisions and the 0009G support/correctness/hygiene/inventory checkpoint. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
