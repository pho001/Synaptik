...
| 0009E1B | Advanced reduction route decision | Draft | 0009E1A | Summary only: LOG_SUM_EXP, variance, standard deviation, L1, and L2 across the current floating attribute/layout/carrier matrix. |
| 0009E1C | Softmax-style reduction route decision | Draft | 0009E1B | Summary only: first-class SOFTMAX/LOG_SOFTMAX stable complete slices and their current validation/carrier matrix. |
