...
| 0009E2 | [Normalization route decision and possible direct-Java migration](tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md) | Ready | 0009E1C | Sole detailed frontier: decide the complete first-class static Layer/RMS route by strict implementation-and-verification cost while preserving current numerical, carrier, geometry, workspace, and cold-binding boundaries; batch normalization remains 0009F. |
| 0009E3 | Loss direct-Java migration | Draft | 0009E2; CPU 0008I fork-0 NON_PASSING | Summary child: static loss loops and orchestration; preserve 19/792 NON_PASSING evidence and user-closed forks 1--4 without a new performance gate. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C remain historical evidence. Parent CPU 0009D is Complete: D1--D4 retained generated routes. E1 retains partial integral, E1A retains masked, E1B1 retains log-sum-exp, E1B2 retains FLOAT64/FLOAT32/BFLOAT16 VARIANCE/STANDARD_DEVIATION, E1B3 retains FLOAT64/FLOAT32/BFLOAT16 L1_NORM/L2_NORM, and E1C retains FLOAT64/FLOAT32/BFLOAT16 SOFTMAX/LOG_SOFTMAX generated routes because direct Java would increase implementation and verification work. E1B and E1C are Complete; E2 is the sole Ready detailed frontier, while E3, 0009F, and 0009G remain Draft summaries. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
