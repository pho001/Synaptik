...
| 0009F | MATMUL, convolution, pooling, attention, and batch-normalization hybrid parent | Draft | 0009E3 | Sole next Draft summary frontier. Parent only: make explicit per-family retained-generation/direct-Java decisions; do not apply a universal structural verifier. |
