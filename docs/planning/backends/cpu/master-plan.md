...
| 0008Q | [Finite scalar-immediate and clamp generated-code equivalence](tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) | Ready | 0005F, 0005G, 0005J, 0008J, 0008L; current schema-63 pointwise lowering/preparation/generation | Test-only finite fixtures prove constants-only Class-File equivalence only within distinct opcode/type/carrier/layout/strategy/power-realization/constant-encoding/edge-value/shape units; preserve exact production identity and fixture hashes, otherwise fail closed. |
| 0009 | [Portable generated-coverage closure checkpoint](tasks/0009-portable-generated-coverage-closure-checkpoint.md) | Blocked | 0001–0008P, CPU 0008Q Complete, explicitly including 0005A–0005J, corrective 0007A0A–0007A1O and any later residual corrections selected before 0007A2, 0007A–0007F2 including 0007A1/0007A2 and 0007F/0007F1/0007F2, Prepare 0003A, CPU 0008E1, CPU 0008G1, and the ordered 0008A–0008P sequence; complete current selected Model semantic inventory | Bounded source-derived inventory and evidence closure: distinguish capability/admission/selection; ledger exact Class-File hashes and CPU 0008Q finite projection provenance without enumerating arbitrary immediates; retain 0008I missing, 0008O non-passing, and 0008P `KEEP_WHOLE_CELL`; rerun only justified finite missing/stale/non-representative hot forms. |
...
and CPU 0008Q is Ready as the active finite scalar-immediate/clamp equivalence frontier; CPU 0009 is Blocked on its completion and returns to Ready afterward. CPU 0010 through 0017 remain Draft. Prepare
0003A is Complete.
