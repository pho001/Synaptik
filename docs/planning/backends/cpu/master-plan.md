...
0008I is the next Draft CPU loss-family frontier without a detailed specification. CPU 0008A is `Complete`: it validates Conv1d through the explicit Conv2d
...
Draft CPU family frontier without a detailed specification. The inserted pooling order is Model 0025I -> Model 0025J -> Model 0025K -> Compiler
...
[CPU 0008H](tasks/0008h-portable-scaled-dot-product-attention-execution.md) is `Complete`; CPU
0008I is the next Draft CPU implementation frontier without a detailed specification.
...
0008I is the next Draft CPU frontier without a detailed specification, and CPU 0008J through 0017 remain Draft. Prepare
0003A is Complete.
...
- Complete CPU 0008 is narrowed from the former five-family Draft row to one grouped NCHW
  ...
  detailed Complete CPU 0008H delivers attention execution; Draft CPU 0008I is the next loss-family
  frontier without a detailed specification. This planning
