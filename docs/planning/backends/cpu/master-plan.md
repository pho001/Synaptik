...
| 0009E | Reductions, normalizations, and loss direct-Java migration parent | Draft | 0009D4 | Parent only: split static reductions, normalization, and loss into bounded summary children; no giant implementation task or performance gate. |
| 0009E1 | Static reductions direct-Java migration | Draft | 0009E | Summary child: partial, masked, advanced, statistical, logarithmic, and softmax-style static reductions; create a detailed spec only at the frontier. |
| 0009E2 | Normalization direct-Java migration | Draft | 0009E1 | Summary child: layer/RMS and static normalization loops, with exact current numerical semantics. |
