...
| 0009D | [Aggregate, scan, ordering, and fold route-closure parent](tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) | Ready | 0009C; completed 0009D1A | Sequence explicit lowest-cost route decisions: D1 retains supported aggregate generation; D2 scans next; ordering then fold. No universal structural verifier or benchmark gate. |
...
| 0009D3 | Ordering direct-Java migration | Draft | 0009D2 | Summary only: migrate static ordering/index/scratch topology to typed Java entries; no universal structural verifier. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2 remain historical evidence. Parent CPU 0009D remains Ready: D1 retained the complete ordinary aggregate generated route because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split complexity. D2 retained the complete generated scan route because a direct replacement would duplicate typed carrier/layout, BFLOAT16, complete-slice range, and guarded segment bodies while adding retirement evidence. D3 ordering is the next summary-only frontier; D4 fold remains summary-only. CPU 0009E is split into summary reductions, normalization, and loss children; CPU 0009F makes explicit hybrid decisions for retained generated MATMUL/convolution and pooling/attention/batch-norm orchestration; CPU 0009G is final support/correctness/hygiene/inventory closure. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
