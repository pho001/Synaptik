...
| 0009F | [Hybrid route decisions for specialized compute families](tasks/0009f-hybrid-route-decisions-for-specialized-compute-families.md) | Ready | 0009E3 | Incomplete parent. F1 and F2 pooling are complete; F3 is the sole next Draft summary frontier. Parent governs separate MATMUL/convolution, pooling, attention, and batch-normalization decisions; do not apply a universal structural verifier or common route mandate. |
...
| 0009F3 | Attention and batch-normalization hybrid decision | Draft | 0009F2 | Sole next summary frontier; do not detail it early. |
