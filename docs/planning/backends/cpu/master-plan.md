...
| 0009E1B3 | [Norm reduction route decision](tasks/0009e1b3-norm-reduction-route-decision.md) | Ready | 0009E1B2 | Sole next detailed child: decide the L1 exact-absolute-sum/exact-state and L2 scaled-squares/zero-workspace generated-versus-direct routes without a performance claim. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2 remain historical evidence. Parent CPU 0009D is Complete: D1--D4 retained generated routes. E1 retains partial integral, E1A retains masked, E1B1 retains log-sum-exp, and E1B2 retains FLOAT64/FLOAT32/BFLOAT16 VARIANCE/STANDARD_DEVIATION generated routes because direct Java would increase implementation and verification work. E1B remains a Draft parent split by distinct numerical ownership; [E1B3 norms](tasks/0009e1b3-norm-reduction-route-decision.md) is the sole next Ready detailed child, while E1C, E2, E3, 0009F, and 0009G remain Draft summaries. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
