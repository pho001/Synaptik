...
and CPU 0008Q is Complete as a strict two-fixture BFLOAT16 scalar-MUL mechanism only. CPU 0009 remains Blocked on a future separately planned complete scalar-immediate/clamp matrix task and its documentation pass. CPU 0010 through 0017 remain Draft. Prepare
0003A is Complete.
