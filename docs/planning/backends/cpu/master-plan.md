...
- Detailed complete [0008D](tasks/0008d-bounded-fusion-profitability-and-typed-decision-facts.md)
  ...
  CPU routes, and Tuning 0002 may measure eligible complete plans when the user explicitly requests
