...
| 0009E1A | Masked reduction route decision | Draft | 0009E1 | Sole next summary frontier: current masked FLOAT64/FLOAT32/BFLOAT16 SUM/MEAN, directional BOOL broadcast, exact-state workspace, and typed carrier/layout matrix. |
