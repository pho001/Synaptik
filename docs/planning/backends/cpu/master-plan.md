...
| 0009E3 | [Loss route decision and possible direct-Java migration](tasks/0009e3-loss-route-decision-and-possible-direct-java-migration.md) | Ready | 0009E2; CPU 0008I fork-0 NON_PASSING | Sole detailed frontier: decide MSE, dense categorical, and index categorical static loss routes per family by total implementation/verification/retirement cost; preserve 19/792 NON_PASSING evidence and user-closed forks 1--4 without a new performance gate. |
| 0009F | MATMUL, convolution, pooling, attention, and batch-normalization hybrid parent | Draft | 0009E3 | Parent only: make explicit per-family retained-generation/direct-Java decisions; do not apply a universal structural verifier. |
...
completed documentation pass. CPU 0009 remains Ready and incomplete. Completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C/E2 remain historical evidence. Parent CPU 0009D is Complete: D1--D4 retained generated routes. E1 retains partial integral, E1A retains masked, E1B1 retains log-sum-exp, E1B2 retains FLOAT64/FLOAT32/BFLOAT16 VARIANCE/STANDARD_DEVIATION, E1B3 retains FLOAT64/FLOAT32/BFLOAT16 L1_NORM/L2_NORM, E1C retains FLOAT64/FLOAT32/BFLOAT16 SOFTMAX/LOG_SOFTMAX, and E2 retains static Layer/RMS generated routes because direct Java would increase implementation and verification work. E1B, E1C, and E2 are Complete; E3 loss is the sole next Ready detailed frontier, while 0009F and 0009G remain later Draft summaries. Exact rejections remain. Existing performance evidence, including the loss fork-0 NON_PASSING result and user-closed forks 1--4, is retained but fresh benchmarking is non-blocking. CPU 0010 through 0017
