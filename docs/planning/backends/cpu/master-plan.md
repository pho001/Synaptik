...
| 0009E1B1 | [Log-sum-exp route decision](tasks/0009e1b1-log-sum-exp-route-decision.md) | Ready | 0009E1A | Sole detailed frontier: decide the zero-workspace two-pass max-shift/compensated LOG_SUM_EXP generated route versus finite direct typed Java. |
| 0009E1B2 | Statistical reduction route decision | Draft | 0009E1B1 | Summary only: variance and standard deviation retain their corrected two-pass exact-mean workspace and special-value ownership. |
