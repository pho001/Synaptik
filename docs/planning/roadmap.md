...
scatter, and 20 random); parent [CPU 0009D](backends/cpu/tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) remains Ready, while [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md) and detailed [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md) are Complete retained-generated-route decisions. D1 preserves the complete ordinary aggregate generated route because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split routing and evidence complexity. D2 preserves the complete generated scan route because direct Java would duplicate typed carrier/layout bodies, BFLOAT16 per-value conversion, complete-slice range ownership, and the guarded segment form while adding replacement and retirement evidence. Neither decision makes a performance claim. [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md) is the sole detailed Ready frontier; D4 fold remains summary-only after it. 0009E splits static reductions, normalization, and loss; 0009F makes family-specific hybrid decisions; 0009G is the final support/correctness/hygiene/inventory checkpoint. Existing performance facts remain reported, but no new benchmark gate blocks correctness closure.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation,
and CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as a strict two-fixture BFLOAT16 scalar-MUL mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), and CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md): completed 0009A--C/D1/D1A/D2 remain historical evidence, parent D remains Ready, and D3 ordering is the sole detailed Ready frontier. D4 fold, split 0009E reductions/normalization/loss, hybrid 0009F, and final 0009G remain ordered summary tasks. The retained loss fork-0 failure remains NON_PASSING historical performance debt; CPU 0010 through CPU 0017
remain Draft.

Current correction: parent CPU 0009D remains Ready; [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md) and [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md) are Complete retained-generated-route decisions. D1A stays completed historical hygiene evidence. [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md) is the sole detailed Ready frontier; fold follows summary-only in order.
...
CPU 0008Q completed a narrow two-fixture BFLOAT16 scalar-MUL represented-immediate mechanism from exact fixture hashes and automated constants-only Class-File normalization; it neither enumerates arbitrary immediate bits nor changes production identity. CPU 0008Q1A and CPU 0008Q1 are Complete with their recorded finite schema-64 evidence. CPU 0009 remains Ready and incomplete: its proportional structural promotion is comparator-backed, not a literal CFG proof, and representative performance remains separate. CPU 0009B is Complete for 845 rows and CPU 0009C is Complete for its exact 2,252 rows; exactly 2,252 generated rows are oracle-proved, while all 17,463 remain performance-partial. Parent CPU 0009D is Ready for aggregate, scan, ordering, and fold route closure; D1, D1A, and D2 are Complete, and D3 is the sole detailed Ready frontier. The 173 cross-category rejections remain 152 `rejected:pointwise` plus 21 other-category rows. The fresh loss fork 0 failed 19 of 792 rows; that is retained NON_PASSING performance debt for the concise post-0009 remediation row, not a semantic or structural support failure. No whole-backend performance-parity claim closes. Detailed CPU
0008J and Model 0025L are `Complete`, detailed CPU 0008K and CPU 0008L are `Complete`; detailed
[CPU 0008M](backends/cpu/tasks/0008m-vector-mse-none.md) is `Complete`, CPU 0008N ended with a
bounded scalar stop, CPU 0008N1 is Complete, CPU 0008O is `Cancelled` with retained fork-0
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation. The ordered CPU 0008J–0008P sequence is complete; completed 0009A--C/D1/D1A/D2 remain historical evidence. CPU 0009D remains Ready; D1 and D2 retain their generated routes, D3 is the sole detailed Ready frontier, and D4 follows summary-only in order. CPU 0009E is split into reductions/normalization/loss, 0009F uses explicit hybrid family decisions, and 0009G is the final support/correctness/hygiene/inventory checkpoint. Loss fork 0 remains NON_PASSING historical evidence after user closure of forks 1--4; it is not a migration gate.

Current correction: parent CPU 0009D remains Ready; D1 and D2 are Complete retained-generated-route decisions; completed D1A remains historical. D3 ordering is the sole detailed Ready child and fold follows summary-only; no conditional structural reconciliation child remains.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation, while CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as the narrow two-fixture mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md), and completed 0009A--C/D1/D1A/D2 remain historical evidence. Parent CPU 0009D is Ready, D1 and D2 retained their generated routes, and D3 is the sole detailed Ready frontier; later direct-Java and hybrid decisions remain summary-only in order. The complete semantic inventory and 6,009 catalog remain historical inspection evidence, while retained loss fork-0 evidence remains NON_PASSING and fresh profiling is non-blocking absent a correctness regression; CPU 0010–0017 and the refined Config, Metal, and tuning rows remain
`Draft`.

Current correction: parent CPU 0009D is Ready; [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md) and [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md) are Complete retained-generated-route decisions. D1A remains Complete historical evidence. [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md) is the sole detailed Ready child; fold follows with no detailed specification. Reductions/normalization/loss and the hybrid compute-family decisions remain later summary work.
