...
after that activation task. ReLU remains current from completed
...
[task 0019A2](modules/model/tasks/0019a2-one-hot-encoding.md) are also complete. Linear and attention remain
separated into Draft tasks 0019D and 0019E without
changing established tasks 0019B–0019E. No model task is currently Ready.
...
Complete. Task 0019A2 is also Complete; tasks 0019B–0019E and later tasks remain Draft. No model
...
| 100 | 0019D Linear convenience | Draft |
| 101 | 0019E Scaled dot-product attention | Draft |
| 102 | 0020 Convolution and pooling operations | Draft |
| 103 | 0021 Normalization operations | Draft |
| 104 | 0022 Loss operations | Draft |
| 105 | 0023 Compiler-generated semantic operations | Draft |
| 106 | 0024 Model capability selection audit | Draft |
...
complete. Tasks 0019A, 0019A1, and 0019A2 are also complete. Tasks 0019B–0019E and every later
