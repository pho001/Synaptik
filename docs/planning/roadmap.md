...
scatter, and 20 random); parent [CPU 0009D](backends/cpu/tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) is Complete. Its D1--D4 children retained generated routes because a direct replacement would add greater implementation and verification cost, with no performance claim. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md), [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md), [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md), [E1B2 statistical reductions](backends/cpu/tasks/0009e1b2-statistical-reduction-route-decision.md), [E1B3 norms](backends/cpu/tasks/0009e1b3-norm-reduction-route-decision.md), and [E1C softmax-style](backends/cpu/tasks/0009e1c-softmax-style-reduction-route-decision.md) are Complete retained generated routes. E1C retains the complete FLOAT64/FLOAT32/BFLOAT16 SOFTMAX/LOG_SOFTMAX three-pass complete-slice route because direct Java would duplicate its typed carrier/layout, cold selection/binding, immutable invocation, artifact/cache, oracle, inventory, and retirement proof. E1B and E1C are Complete; [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md) is the sole Ready detailed frontier, while loss, 0009F, and 0009G remain ordered Draft summaries. Existing performance facts remain reported, but no new benchmark gate blocks correctness closure.
Current correction: E1B and E1C are Complete retained generated routes, with no performance claim; parent CPU 0009 and parent E remain incomplete, [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md) is the sole Ready detailed frontier, and E3, 0009F, and 0009G remain Draft summaries.
...
bounded scalar stop, CPU 0008N1 is Complete, CPU 0008O is `Cancelled` with retained fork-0
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation. The ordered CPU 0008J–0008P sequence is complete; completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C remain historical evidence. CPU 0009D is Complete because D1 through D4 retain generated routes. CPU 0009E1, E1A, E1B1, E1B2, E1B3, and E1C are Complete retained generated routes; E1B3 retains L1_NORM/L2_NORM and E1C retains SOFTMAX/LOG_SOFTMAX because direct Java would increase implementation and verification work, without a performance claim. E1B and E1C are Complete; [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md) is the sole Ready detailed frontier, while E3, 0009F, and 0009G remain Draft summaries. Loss fork 0 remains NON_PASSING historical evidence after user closure of forks 1--4; it is not a migration gate.

Current correction: parent CPU 0009D is Complete because D1 through D4 are Complete retained-generated-route decisions. Completed D1A remains historical. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md), [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md), [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md), [E1B2 statistical reductions](backends/cpu/tasks/0009e1b2-statistical-reduction-route-decision.md), [E1B3 norms](backends/cpu/tasks/0009e1b3-norm-reduction-route-decision.md), and [E1C softmax-style](backends/cpu/tasks/0009e1c-softmax-style-reduction-route-decision.md) are Complete retained generated routes. E1B and E1C are Complete; [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md) is the sole Ready detailed frontier; E3, 0009F, and 0009G remain Draft summaries. No conditional structural reconciliation child remains.
