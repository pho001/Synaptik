...
scatter, and 20 random); parent [CPU 0009D](backends/cpu/tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) remains Ready, while [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md) is Complete as a retained-generated-route decision. D1 preserves the complete ordinary aggregate generated route because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split routing and evidence complexity; it makes no performance claim. Detailed [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md) is Ready and decides direct Java only if it is genuinely simpler; D3 ordering and D4 fold remain summary-only in order. 0009E splits static reductions, normalization, and loss; 0009F makes family-specific hybrid decisions; 0009G is the final support/correctness/hygiene/inventory checkpoint. Existing performance facts remain reported, but no new benchmark gate blocks correctness closure.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation,
and CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as a strict two-fixture BFLOAT16 scalar-MUL mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), and CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md): completed 0009A--C/D1/D1A remain historical evidence, parent D remains Ready, and detailed D2 is Ready after D1 retained the complete aggregate generated route. D3 ordering, D4 fold, split 0009E reductions/normalization/loss, hybrid 0009F, and final 0009G remain ordered summary tasks. The retained loss fork-0 failure remains NON_PASSING historical performance debt; CPU 0010 through CPU 0017
remain Draft.

Current correction: parent CPU 0009D remains Ready; [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md) is Complete as a retained-generated-route decision; and [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md) is the detailed Ready frontier. D1A stays completed historical hygiene evidence. D2 has an explicit direct-versus-retained decision gate; ordering and fold remain ordered summary-only follow-ups.
