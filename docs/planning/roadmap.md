...
| 10 | [`backends/cpu`](backends/cpu/master-plan.md) | In progress (CPU 0010B Complete; CPU 0010C Draft frontier) | Model, config, planning, runtime, prepare, backend-contract, trace, and OpenBLAS contracts are ready. | CPU is a conforming reference backend for the selected capability set. |
