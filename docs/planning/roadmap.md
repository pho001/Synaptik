...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation,
and CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as a strict two-fixture BFLOAT16 scalar-MUL mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), and CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md): completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C/E2/E3 remain historical evidence. CPU 0009E1, E1A, E1B1, E1B2, E1B3, E1C, E2, and E3 are Complete retained generated routes. E3 independently retains MSE, dense categorical, and index categorical generated routes because direct replacement would increase implementation and verification cost, without a performance claim. CPU 0009 remains incomplete; 0009F1 and F2 pooling are Complete, F3 is the sole detailed Ready frontier under Ready incomplete parent 0009F, and final 0009G remains later Draft. The retained loss fork-0 failure remains NON_PASSING historical performance debt; CPU 0010 through CPU 0017
remain Draft.
...
bounded scalar stop, CPU 0008N1 is Complete, CPU 0008O is `Cancelled` with retained fork-0
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation. The ordered CPU 0008J–0008P sequence is complete; completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C/E2/E3 remain historical evidence. CPU 0009D is Complete because D1 through D4 retain generated routes. CPU 0009E1, E1A, E1B1, E1B2, E1B3, E1C, E2, and E3 are Complete retained generated routes; E3 independently retains MSE, dense categorical, and index categorical generated routes because direct Java would increase implementation and verification work, without a performance claim. CPU 0009 remains incomplete; 0009F1 and F2 pooling are Complete, F3 is the sole detailed Ready frontier under Ready incomplete parent 0009F, and 0009G remains later Draft. Loss fork 0 remains NON_PASSING historical evidence after user closure of forks 1--4; it is not a migration gate.

Current correction: parent CPU 0009D is Complete because D1 through D4 are Complete retained-generated-route decisions. Completed D1A remains historical. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md), [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md), [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md), [E1B2 statistical reductions](backends/cpu/tasks/0009e1b2-statistical-reduction-route-decision.md), [E1B3 norms](backends/cpu/tasks/0009e1b3-norm-reduction-route-decision.md), [E1C softmax-style](backends/cpu/tasks/0009e1c-softmax-style-reduction-route-decision.md), [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md), and [E3 loss](backends/cpu/tasks/0009e3-loss-route-decision-and-possible-direct-java-migration.md) are Complete retained generated routes. CPU 0009 remains incomplete; 0009F1 and F2 pooling are Complete, F3 is the sole detailed Ready frontier under Ready incomplete parent 0009F, and 0009G remains later Draft. No conditional structural reconciliation child remains.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation, while CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as the narrow two-fixture mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md), and completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A/E1B1/E1B2/E1B3/E1C/E2/E3 remain historical evidence. Parent CPU 0009D is Complete because D1 through D4 retained generated routes. CPU 0009E1, E1A, E1B1, E1B2, E1B3, E1C, E2, and E3 are Complete retained generated routes; E1B3 retains L1_NORM/L2_NORM, E1C retains SOFTMAX/LOG_SOFTMAX, E2 retains static Layer/RMS normalization, and E3 separately retains MSE, dense categorical, and index categorical generated routes because direct Java would increase implementation and verification work, without a performance claim. E1B and E1C are Complete; CPU 0009 remains incomplete, 0009F1 and F2 pooling are Complete, and F3 is the sole detailed Ready frontier under Ready incomplete parent 0009F; 0009G remains later Draft. The complete semantic inventory and 6,009 catalog remain historical inspection evidence, while retained loss fork-0 evidence remains NON_PASSING and fresh profiling is non-blocking absent a correctness regression; CPU 0010–0017 and the refined Config, Metal, and tuning rows remain
`Draft`.

Current correction: parent CPU 0009D is Complete. [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md), [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md), [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md), and [D4 fold/window](backends/cpu/tasks/0009d4-fold-window-route-decision-and-possible-direct-java-migration.md) are Complete retained-generated-route decisions. D1A remains Complete historical evidence. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md), [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md), [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md), [E1B2 statistical reductions](backends/cpu/tasks/0009e1b2-statistical-reduction-route-decision.md), [E1B3 norms](backends/cpu/tasks/0009e1b3-norm-reduction-route-decision.md), [E1C softmax-style](backends/cpu/tasks/0009e1c-softmax-style-reduction-route-decision.md), [E2 normalization](backends/cpu/tasks/0009e2-normalization-route-decision-and-possible-direct-java-migration.md), and [E3 loss](backends/cpu/tasks/0009e3-loss-route-decision-and-possible-direct-java-migration.md) are Complete retained generated routes. E3 independently retains complete MSE, dense categorical, and index categorical generated routes because direct Java would increase implementation and verification work. CPU 0009 remains incomplete; 0009F1 and F2 pooling are Complete, F3 is the sole detailed Ready frontier under Ready incomplete parent 0009F, and 0009G remains later Draft.
