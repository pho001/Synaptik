...
for average pooling. Task 0020A1 is the only detailed task after 0020A; tasks 0021–0024 remain
Draft without detailed specifications, and no model task is Ready.
...
tasks 0020, 0020A, and 0020A1 are Complete; no model task is Ready.
...
0020, 0020A, and 0020A1 are Complete. Task 0020A1 remains the only detailed specification after
0020A; tasks 0021–0024 remain Draft without detailed future specs.
