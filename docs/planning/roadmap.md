...
is Ready immediately before its parent to remediate all current FLOAT32/FLOAT64 vector scalar-power
specializations and carrier forms. CPU 0008Q1 is Blocked on 0008Q1A and its documentation pass,
and CPU 0009 remains Blocked on the remediation, completed matrix, and both documentation passes. CPU
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation,
and CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as a strict two-fixture BFLOAT16 scalar-MUL mechanism, CPU 0008Q1A is [`Ready`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Blocked`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md) on 0008Q1A and its documentation pass, and CPU 0009 is [`Blocked`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md) on both tasks and documentation passes; CPU 0010 through CPU 0017
remain Draft.
CPU 0003
implements a
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation.
CPU 0009 depends on [CPU 0008Q1A](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), [CPU 0008Q1](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), and both documentation passes, in addition to CPU 0008Q's narrow two-fixture constants-only mechanism proof, as well as the ordered CPU 0008A–0008E, Prepare 0003A, CPU 0008E1, and CPU 0008F–0008P
sequence
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation, while CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as the narrow two-fixture mechanism, CPU 0008Q1A is [`Ready`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Blocked`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md) on it and its documentation pass, and CPU 0009 is [`Blocked`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md) on both tasks and documentation passes; CPU 0010–0017 and the refined Config, Metal, and tuning rows remain
