...
scatter, and 20 random); parent [CPU 0009D](backends/cpu/tasks/0009d-aggregate-scan-ordering-fold-structural-oracle-closure.md) is Complete: [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md), detailed [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md), [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md), and [D4 fold/window](backends/cpu/tasks/0009d4-fold-window-route-decision-and-possible-direct-java-migration.md) are retained-generated-route decisions. D1 preserves aggregate generation because direct migration would duplicate exact primitive-limb/scratch machinery or add partial-split routing and evidence complexity. D2 preserves scan generation because direct Java would duplicate typed carrier/layout bodies, BFLOAT16 per-value conversion, complete-slice range ownership, and the guarded segment form while adding replacement and retirement evidence. D3 preserves the 192-row ordering route because direct Java would duplicate typed carrier/layout forms, stable comparison, logical indices, unsorted `TOP_K`, cold binding, two-region scratch, and replacement/retirement proof. D4 preserves the complete 32-row fold family because direct Java would duplicate five typed axis and three typed 2D bodies across four carrier combinations, dense/general forms, cold selection/binding, output ranges, exact mapping/rejections, BFLOAT16 per-addition rounding, integral wraparound, and replacement/invocation/retirement evidence. None makes a performance claim. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md) and [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md) are Complete retained generated routes. E1A retains the complete FLOAT64/FLOAT32/BFLOAT16 masked SUM/MEAN route because direct Java would duplicate typed carrier/layout bodies, directional BOOL addressing, selected exact-state finalization, cold binding, invocation, inventory, and retirement proof. E1B is a Draft parent split by distinct numerical ownership; [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md) is the sole detailed Ready frontier, while E1B2 statistics, E1B3 norms, softmax, normalization, and loss remain ordered master-plan summaries, followed by 0009F family-specific hybrid decisions and 0009G support/correctness/hygiene/inventory closure. Existing performance facts remain reported, but no new benchmark gate blocks correctness closure.
Current correction: [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md) is Complete as a retained generated route: a direct replacement would duplicate the typed carrier/layout matrix, directional BOOL addressing, selected exact-state finalization, cold binding, invocation, inventory, and retirement proof. Parent CPU 0009 and parent E remain incomplete. E1B is a `Draft` advanced-reduction parent split only because log-sum-exp, corrected statistics, and norms have distinct numerical ownership; [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md) is the sole detailed `Ready` frontier, followed by summary-only E1B2 statistics, E1B3 norms, E1C, E2, E3, F, and G.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation,
and CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as a strict two-fixture BFLOAT16 scalar-MUL mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), and CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md): completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A remain historical evidence. Parent D is Complete because D4 retained the full 32-row generated fold/window family after finding that direct Java would increase total implementation and verification work. CPU 0009E1 and E1A are Complete retained generated routes; E1A retains the complete masked FLOAT64/FLOAT32/BFLOAT16 SUM/MEAN route because direct Java would duplicate typed carrier/layout, directional mask, selected exact-state, binding, invocation, inventory, and retirement work. E1B is a Draft parent split by distinct numerical ownership; E1B1 log-sum-exp is the sole detailed Ready frontier, while E1B2/E1B3 and E1C--E3 remain ordered summaries, followed by hybrid 0009F and final 0009G. The retained loss fork-0 failure remains NON_PASSING historical performance debt; CPU 0010 through CPU 0017
remain Draft.
...
bounded scalar stop, CPU 0008N1 is Complete, CPU 0008O is `Cancelled` with retained fork-0
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation. The ordered CPU 0008J–0008P sequence is complete; completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A remain historical evidence. CPU 0009D is Complete because D1 through D4 retain their generated routes; D4's 32-row fold family remains generated because direct Java would increase total implementation and verification work. CPU 0009E1 and E1A are Complete retained generated routes; E1A retains the complete masked FLOAT64/FLOAT32/BFLOAT16 SUM/MEAN route because direct Java would increase implementation and verification work. E1B is a Draft parent split by distinct numerical ownership; E1B1 log-sum-exp is the sole detailed Ready frontier, E1B2/E1B3 and E1C--E3 remain ordered summaries, 0009F uses explicit hybrid family decisions, and 0009G is the final support/correctness/hygiene/inventory checkpoint. Loss fork 0 remains NON_PASSING historical evidence after user closure of forks 1--4; it is not a migration gate.

Current correction: parent CPU 0009D is Complete because D1 through D4 are Complete retained-generated-route decisions; D4 retains the complete fold family after finding direct replacement more costly to implement and verify. Completed D1A remains historical. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md) and [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md) are Complete retained generated routes. E1B is a Draft parent split by distinct advanced numerical ownership; [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md) is the sole detailed Ready frontier, while E1B2/E1B3 and later E children remain summary-only. No conditional structural reconciliation child remains.
...
`KEEP_SCALAR` evidence but no completed five-fork acceptance, and CPU 0008P is Complete with its
modular partial/combine implementation fail-closed at `KEEP_WHOLE_CELL`, not floating reassociation, while CPU 0008Q is [`Complete`](backends/cpu/tasks/0008q-scalar-immediate-clamp-generated-equivalence.md) as the narrow two-fixture mechanism, CPU 0008Q1A is [`Complete`](backends/cpu/tasks/0008q1a-vector-scalar-power-hot-path-self-containment.md), CPU 0008Q1 is [`Complete`](backends/cpu/tasks/0008q1-finite-scalar-immediate-clamp-matrix.md), CPU 0009 is [`Ready`](backends/cpu/tasks/0009-portable-generated-coverage-closure-checkpoint.md), and completed 0009A--C/D1/D1A/D2/D3/D4/E1/E1A remain historical evidence. Parent CPU 0009D is Complete because D1 through D4 retained their generated routes; D4 keeps its 32-row fold/window family generated because direct Java would increase total implementation and verification work. CPU 0009E1 and E1A are Complete retained generated routes; E1A retains the complete masked SUM/MEAN route because direct Java would increase implementation and verification work. E1B is a Draft parent split by distinct numerical ownership; E1B1 log-sum-exp is the sole detailed Ready frontier, while E1B2/E1B3 and later E children and hybrid decisions remain summary-only in order. The complete semantic inventory and 6,009 catalog remain historical inspection evidence, while retained loss fork-0 evidence remains NON_PASSING and fresh profiling is non-blocking absent a correctness regression; CPU 0010–0017 and the refined Config, Metal, and tuning rows remain
`Draft`.

Current correction: parent CPU 0009D is Complete. [CPU 0009D1 aggregate](backends/cpu/tasks/0009d1-aggregate-structural-oracle-closure.md), [CPU 0009D2 scan](backends/cpu/tasks/0009d2-scan-route-decision-and-possible-direct-java-migration.md), [D3 ordering](backends/cpu/tasks/0009d3-ordering-index-scratch-direct-java-migration.md), and [D4 fold/window](backends/cpu/tasks/0009d4-fold-window-route-decision-and-possible-direct-java-migration.md) are Complete retained-generated-route decisions. D1A remains Complete historical evidence. [CPU 0009E1 partial integral reduction](backends/cpu/tasks/0009e1-partial-integral-reduction-direct-java-migration.md) and [CPU 0009E1A masked reduction](backends/cpu/tasks/0009e1a-masked-reduction-route-decision.md) are Complete retained generated routes. E1B is a Draft parent; [E1B1 log-sum-exp](backends/cpu/tasks/0009e1b1-log-sum-exp-route-decision.md) is the sole detailed Ready frontier, while E1B2/E1B3 and later E children remain summaries.
