...
For contributor instructions on adding a new operation to these layers, see [Adding A Tensor Operation: Implementation Checklist](adding-tensor-operation.md#implementation-checklist).
