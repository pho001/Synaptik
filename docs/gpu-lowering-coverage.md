...
| loss-adjacent ops | `NLL_LOSS`, `CROSS_ENTROPY_LOSS` | unsupported | `DAG_PRIMITIVE_UNSUPPORTED`; Phase 37 locks the dense `FLOAT32`, dense-layout, rank 1..4, mean-reduced scalar contract before native/lowered execution is admitted |
